...
func NewMockDatabase(shouldError bool) *MockDB {
	...
	testAdventure := types.NewAdventureRecord(1, 1, 5, *types.NewCoins(1000, 1000, 1000, 1000, 1000), []types.Gem{}, []types.Jewellery{}, []types.MonsterGroup{}, []types.MagicItem{}, []types.AdventureCharacter{}, "Test Adventure", time.Now())
